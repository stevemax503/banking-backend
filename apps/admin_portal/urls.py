...
urlpatterns = [
    ...
    path('users/<uuid:pk>/set-password/', views.admin_set_user_password, name='admin-user-set-password'),
    path('users/<uuid:pk>/send-password-reset/', views.admin_send_password_reset, name='admin-user-send-password-reset'),
